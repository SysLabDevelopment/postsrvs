(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-courier-courier-module"], {
    ...
    function srcAppPagesCourierCourierPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_services_sys_map_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! src/app/services/sys/map.service */
      "./src/app/services/sys/map.service.ts");
      /* harmony import */


      var _components_help_help_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      ...
      function CourierPage_div_29_ion_item_3_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function CourierPage_div_29_ion_item_3_Template_ion_item_click_0_listener() {
            ...
            return ctx_r23.selectOrder(order_r12.id);
          });
      ...
      function CourierPage_div_29_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("ionChange", function CourierPage_div_29_Template_ion_searchbar_ionChange_1_listener($event) {
            ...
            return ctx_r26.onSearchChange($event);
      ...
      function CourierPage_div_31_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("change", function CourierPage_div_31_Template_input_change_4_listener() {
            ...
            return ctx_r42.scanInputChange();
      ...
      var CourierPage = /*#__PURE__*/function () {
        function CourierPage(courier, router, state$, auth, bs, vbr, settings, sys, data, popoverController, map) {
          ...
          this.state$.state.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["takeUntil"])(this.local_stop$)).subscribe(function (state) {
            var a = state;
        ...
        _createClass(CourierPage, [{
          ...
          value: function prepareOrdersList() {
            ...
            this.orders_c = this.ord.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])(function (orders) {
            ...
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["map"])(function (orders) {
              orders.forEach(function (order) {
                order.show = false;
              });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵsetClassMetadata"](CourierPage, [{
          ...
          return [{
            ...
            type: src_app_services_sys_map_service__WEBPACK_IMPORTED_MODULE_10__["MapService"]
          }];
        }, {
          reorderGroup: [{
