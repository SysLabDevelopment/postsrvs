(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    /***/
    function srcAppServicesSysDataServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        function DataService(storage, courier, auth, sys) {
          ...
          storage.ready().then(function (localforage) {
            ...
            _this.orders.subscribe(function (orders) {
              _this.storage.set('orders', orders);
            });
          });
        }
        ...
        _createClass(DataService, [{
          ...
          value: function getInitialData() {
            ...
            this.storage.ready().then(function () {
              _this2.storage.keys().then(function (keys) {
                return console.log('записи в стораже: ', keys);
              });

              _this2.storage.get('orders').then(function (orders) {
      ...
      var MapService = /*#__PURE__*/function () {
        ...
        _createClass(MapService, [{
              ...
              return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 18:
                      return _context3.abrupt("return", Promise.resolve(this.map));
          ...
          value: function _loadMap(divId, options) {
            ...
            return new Promise(function (resolve) {
              _this5.map.one(_ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_6__["GoogleMapsEvent"].MAP_READY).then(function () {
                resolve();
              });
            });
          }
