  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["styles"], {
    ...
    function node_modulesCssLoaderDistCjsJsNode_modulesPostcssLoaderSrcIndexJsNode_modulesResolveUrlLoaderIndexJsNode_modulesSassLoaderDistCjsJsSrcAppAppScss(module, exports, __webpack_require__) {
      ...
      exports.push([module.i, ".my-custom-menu {\n  --width: 500px;\n}\n\n#bottom-menu {\n  position: absolute;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  display: grid;\n  grid-template-columns: repeat(auto-fill, auto);\n  grid-template-columns: repeat(auto-fit, minmax(70px, 1fr));\n  grid-auto-rows: 40px;\n  background: #2b637e;\n  color: #fff;\n  font-size: 25px;\n}\n\n.bm-item {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.active {\n  background-color: #e5eeeb;\n  color: #2b637e;\n}\n\n.check_to_work {\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  background: white;\n}\n\n.filial {\n  font-size: 0.6em;\n}\n\n.shirm {\n  position: fixed;\n  top: 40vh;\n  left: 40vw;\n  right: 40vw;\n  bottom: 40vh;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background: RGBA(0, 0, 0, 0);\n  z-index: 99999999;\n}\n\n.shirm i {\n  position: relative;\n  margin: auto;\n  font-size: 43px;\n  color: #2b637e;\n}\n\napp-orders-list-guess {\n  width: 100vw;\n}\n\n@font-face {\n  font-family: \"Roboto\";\n  src: url('Roboto.ttf');\n}\n\n:root ion-header * {\n  font-size: 16px;\n}\n\n:root ion-header * ion-toolbar {\n  --background: #2b637e;\n  color: white;\n  text-align: center;\n  --min-height: 30px;\n}\n\n:root ion-header * ion-toolbar ion-back-button {\n  height: 30px;\n}\n\n:root ion-header * ion-toolbar ion-button {\n  height: 30px;\n}\n\n:root ion-header * ion-toolbar ion-button ion-icon {\n  font-size: 24px;\n}\n\n:root .actions-button {\n  background: #4ba7c5;\n  box-shadow: -1px -1px 2px rgba(0, 0, 0, 0.05);\n  border-radius: 10px 0px 2px;\n  position: absolute;\n  right: 0;\n  bottom: 0%;\n  width: 25px;\n  height: 35px;\n  text-align: center;\n}\n\n:root .actions-button ion-icon {\n  margin: 50% 0;\n  width: 12px;\n  height: 12px;\n}\n\n:root .turned {\n  transform: rotate(0.5turn);\n}\n\n:root ion-button.action {\n  --background: #2b637e;\n  --border-radius: 2px;\n  font-size: 12px;\n  text-transform: none;\n  --padding-bottom: 7px;\n  --padding-top: 7px;\n  --padding-start: 7px;\n  --padding-end: 7px;\n  font-family: Roboto;\n  --box-shadow: none;\n  margin-right: 13px;\n  margin-left: 0;\n}\n\n:root ion-button.action ion-icon {\n  margin-left: 0;\n}\n\n:root #light-blue-button {\n  --background: #c9e9fa;\n  --color: #2b637e;\n}\n\n:root #light-purple-button {\n  --background: #c9cbfa;\n  --color: #533f69;\n}\n\n:root #light-green-button {\n  --background: #d7f3dd;\n  --color: #3a543b;\n}\n\n.done-order-modal {\n  padding-top: 25px;\n  --border-radius: 4px;\n}\n\n.done-order-modal .title {\n  font-weight: bold;\n}\n\n.done-order-modal .ion-padding {\n  font-size: 14px;\n  overflow: scroll;\n}\n\n.done-order-modal .ion-padding h1 {\n  font-weight: bold;\n  font-size: 14px;\n  text-align: center;\n}\n\n.done-order-modal .ion-padding h1 a {\n  float: right;\n  color: #2b637e;\n  font-weight: normal;\n}\n\n.done-order-modal .ion-padding ion-list ion-item {\n  --padding-start: 0;\n  --padding-end: 0;\n  --border-style: none;\n  font-size: 14px;\n  --min-height: 35px;\n  align-items: baseline;\n}\n\n.done-order-modal .ion-padding ion-list ion-item.block {\n  --border-style: 1px black;\n  --border-color: #d6cfcf;\n  --border-width: 1px;\n  --border-radius: 4px;\n  --padding-start: 0;\n  margin: 10px 0;\n  --inner-border-width: 0;\n  --inner-padding-bottom: 8px;\n  --inner-padding-start: 8px;\n  --inner-padding-top: 8px;\n  --inner-padding-end: 8px;\n  font-size: 14px;\n  line-height: 21px;\n  color: #585454;\n  white-space: pre-wrap;\n  border: 1px solid #d6cfcf;\n  box-sizing: border-box;\n  border-radius: 4px;\n}\n\n.done-order-modal .ion-padding ion-list ion-item.input {\n  --padding-start: 0;\n  --padding-end: 0;\n  --inner-padding-end: 0;\n  margin: 10px 0;\n}\n\n.done-order-modal .ion-padding ion-list ion-item.input ion-label {\n  transform: none;\n}\n\n.done-order-modal .ion-padding ion-list ion-item.input ion-input {\n  border: 1px solid #d6cfcf;\n  box-sizing: border-box;\n  border-radius: 2px;\n  margin: 5px 0;\n}\n\n.done-order-modal .ion-padding ion-list ion-item.input ion-textarea {\n  border: 1px solid #d6cfcf;\n  box-sizing: border-box;\n  border-radius: 2px;\n}\n\n.done-order-modal .ion-padding ion-list ion-item .title {\n  font-weight: bold;\n}\n\n.done-order-modal .ion-padding ion-list ion-item .link {\n  margin-top: 15px;\n  text-decoration: underline;\n  color: #2b637e;\n  font-weight: normal;\n}\n\n.done-order-modal .ion-padding ion-list ion-item ion-toggle {\n  --background-checked: rgba(43, 99, 126, 0.38);\n  --handle-background-checked: #2b637e;\n}\n\n.done-order-modal .ion-padding ion-list ion-item ion-radio {\n  margin-right: 5px;\n}\n\n.done-order-modal .ion-padding p.descr {\n  font-size: 12px;\n  font-style: italic;\n  color: #d12437;\n}\n\n.done-order-modal .ion-padding ion-item.comment {\n  --padding-start: 0;\n  --inner-padding-end: 0;\n}\n\n.done-order-modal .ion-padding ion-item.comment ion-label {\n  font-weight: bold;\n}\n\n.done-order-modal .ion-padding ion-item.comment ion-textarea {\n  border: 1px solid #d6cfcf;\n  box-sizing: border-box;\n  border-radius: 2px;\n}\n\n.done-order-modal .ion-padding ion-button {\n  margin: 15px 13px 15px 0;\n  font-size: 16px;\n  --background: #2b637e;\n  margin-bottom: 0;\n  margin-top: 15px;\n  text-transform: none;\n  --border-radius: 2px;\n  color: white;\n  --padding-bottom: 7px;\n  --padding-top: 7px;\n  --padding-start: 10px;\n  --padding-end: 10px;\n  --inner-padding-bottom: 10px;\n  --inner-padding-top: 10px;\n}\n\n.done-order-modal .ion-padding ion-button.light {\n  --background: #c9e9fa;\n  color: #2b637e;\n  --box-shadow: none;\n}\n", "", {
        ...
        "sources": ["app.scss"],
        "names": [],
        "mappings": "AAOA;EACE,cAAQ;AANV;;AASA;EACE,kBAAkB;EAClB,SAAS;EACT,OAAO;EACP,QAAQ;EACR,aAAa;EACb,8CAA8C;EAC9C,0DAA0D;EAC1D,oBAAoB;EACpB,mBAAmB;EACnB,WAAW;EACX,eAAe;AANjB;;AASA;EACE,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AANrB;;AASA;EACE,yBAAwC;EACxC,cAAc;AANhB;;AASA;EACE,kBAAkB;EAClB,WAAW;EACX,YAAY;EACZ,iBAAiB;AANnB;;AASA;EACE,gBAAgB;AANlB;;AASA;EACE,eAAe;EACf,SAAS;EACT,UAAU;EACV,WAAW;EACX,YAAY;EAGZ,aAAa;EAGb,uBAAuB;EAGvB,mBAAmB;EACnB,4BAA4B;EAC5B,iBAAiB;AANnB;;AASA;EACE,kBAAkB;EAClB,YAAY;EACZ,eAAe;EACf,cAAc;AANhB;;AASA;EACE,YAAY;AANd;;AASA;EACE,qBAAqB;EACrB,sBAAyB;AAN3B;;AASA;EAEI,eAAe;AAPnB;;AAKA;EAKM,qBAAa;EACb,YAAY;EACZ,kBAAkB;EAClB,kBAAa;AANnB;;AAFA;EAWQ,YAAY;AALpB;;AANA;EAeQ,YAAY;AALpB;;AAVA;EAiBU,eAAe;AAHzB;;AAdA;EAuBI,mBAAmB;EACnB,6CAA6C;EAC7C,2BAA2B;EAC3B,kBAAkB;EAClB,QAAQ;EACR,UAAU;EACV,WAAW;EACX,YAAY;EACZ,kBAAkB;AALtB;;AA1BA;EAiCM,aAAa;EACb,WAAW;EACX,YAAY;AAHlB;;AAhCA;EAuCI,0BAA0B;AAH9B;;AApCA;EA2CI,qBAAa;EACb,oBAAgB;EAChB,eAAe;EACf,oBAAoB;EACpB,qBAAiB;EACjB,kBAAc;EACd,oBAAgB;EAChB,kBAAc;EACd,mBAAmB;EACnB,kBAAa;EACb,kBAAkB;EAClB,cAAc;AAHlB;;AAnDA;EAwDM,cAAc;AADpB;;AAvDA;EA6DI,qBAAa;EACb,gBAAQ;AAFZ;;AA5DA;EAkEI,qBAAa;EACb,gBAAQ;AAFZ;;AAjEA;EAuEI,qBAAa;EACb,gBAAQ;AAFZ;;AAKA;EACE,iBAAiB;EACjB,oBAAgB;AAFlB;;AAAA;EAKI,iBAAiB;AADrB;;AAJA;EAQI,eAAe;EACf,gBAAgB;AAApB;;AATA;EAWM,iBAAiB;EACjB,eAAe;EACf,kBAAkB;AAExB;;AAfA;EAgBQ,YAAY;EACZ,cAAc;EACd,mBAAmB;AAG3B;;AArBA;EAwBQ,kBAAgB;EAChB,gBAAc;EA0Cd,oBAAe;EACf,eAAe;EACf,kBAAa;EACb,qBAAqB;AAxC7B;;AA9BA;EA2BU,yBAAe;EACf,uBAAe;EACf,mBAAe;EACf,oBAAgB;EAChB,kBAAgB;EAChB,cAAc;EACd,uBAAqB;EACrB,2BAAuB;EACvB,0BAAsB;EACtB,wBAAoB;EACpB,wBAAoB;EACpB,eAAe;EACf,iBAAiB;EACjB,cAAc;EACd,qBAAqB;EACrB,yBAAyB;EACzB,sBAAsB;EACtB,kBAAkB;AAO5B;;AAnDA;EA+CU,kBAAgB;EAChB,gBAAc;EACd,sBAAoB;EACpB,cAAc;AAQxB;;AA1DA;EAoDY,eAAe;AAU3B;;AA9DA;EAuDY,yBAAyB;EACzB,sBAAsB;EACtB,kBAAkB;EAClB,aAAa;AAWzB;;AArEA;EA6DY,yBAAyB;EACzB,sBAAsB;EACtB,kBAAkB;AAY9B;;AA3EA;EAwEU,iBAAiB;AAO3B;;AA/EA;EA2EU,gBAAgB;EAChB,0BAA0B;EAC1B,cAAc;EACd,mBAAmB;AAQ7B;;AAtFA;EAkFU,6CAAqB;EACrB,oCAA4B;AAQtC;;AA3FA;EAsFU,iBAAiB;AAS3B;;AA/FA;EA2FM,eAAe;EACf,kBAAkB;EAClB,cAAc;AAQpB;;AArGA;EAgGM,kBAAgB;EAChB,sBAAoB;AAS1B;;AA1GA;EAmGQ,iBAAiB;AAWzB;;AA9GA;EAsGQ,yBAAyB;EACzB,sBAAsB;EACtB,kBAAkB;AAY1B;;AApHA;EA4GM,wBAAwB;EACxB,eAAe;EACf,qBAAa;EACb,gBAAgB;EAChB,gBAAgB;EAChB,oBAAoB;EACpB,oBAAgB;EAChB,YAAY;EACZ,qBAAiB;EACjB,kBAAc;EACd,qBAAgB;EAChB,mBAAc;EACd,4BAAuB;EACvB,yBAAoB;AAY1B;;AArIA;EA4HQ,qBAAa;EACb,cAAc;EACd,kBAAa;AAarB",
        "file": "app.scss",
    ...
    function _(module, exports, __webpack_require__) {
      __webpack_require__(
      /*! /Users/timkovik/Library/Mobile Documents/com~apple~CloudDocs/Documents/Repositories/postsrvs/src/theme/variables.scss */
      "./src/theme/variables.scss");

      __webpack_require__(
      /*! /Users/timkovik/Library/Mobile Documents/com~apple~CloudDocs/Documents/Repositories/postsrvs/src/global.scss */
      "./src/global.scss");

      module.exports = __webpack_require__(
      /*! /Users/timkovik/Library/Mobile Documents/com~apple~CloudDocs/Documents/Repositories/postsrvs/src/app/app.scss */
      "./src/app/app.scss");
      /***/
    }
  }, [[3, "runtime"]]]);
