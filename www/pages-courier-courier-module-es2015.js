...
/* harmony import */ var src_app_services_sys_map_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/services/sys/map.service */ "./src/app/services/sys/map.service.ts");
/* harmony import */ var src_app_services_sys_order_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/app/services/sys/order.service */ "./src/app/services/sys/order.service.ts");
...
/* harmony import */ var _components_note_note_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../components/note/note.component */ "./src/app/components/note/note.component.ts");
...
/* harmony import */ var _services_courier_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../services/courier.service */ "./src/app/services/courier.service.ts");
/* harmony import */ var _services_settings_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../services/settings.service */ "./src/app/services/settings.service.ts");
...
/* harmony import */ var _services_sys_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../services/sys.service */ "./src/app/services/sys.service.ts");
...
/* harmony import */ var angular_feather__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! angular-feather */ "./node_modules/angular-feather/fesm2015/angular-feather.js");
...
class CourierPage {
    constructor(courier, router, state$, auth, bs, vbr, settings, sys, data, popoverController, map, orderService, CL) {
        ...
        this.state$.state.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["takeUntil"])(this.local_stop$)).subscribe((state) => {
            const a = state;
    ...
    prepareOrdersList(ids = [1]) {
        this.orders_c = this.ord.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["map"])(orders => orders && orders.filter(order => ids.includes(Number(order.status_id)))
            ...
            .slice(this.slicer)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["map"])((orders) => { orders.forEach((order) => { order.show = false; }); this.orders = orders; return orders; }));
    }
    howSlice() {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵsetClassMetadata"](CourierPage, [{
    ...
    }], function () { return [{ type: _services_courier_service__WEBPACK_IMPORTED_MODULE_16__["CourierService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }, { type: _services_state_service__WEBPACK_IMPORTED_MODULE_18__["StateService"] }, { type: _services_auth_service__WEBPACK_IMPORTED_MODULE_15__["AuthService"] }, { type: _ionic_native_barcode_scanner_ngx__WEBPACK_IMPORTED_MODULE_5__["BarcodeScanner"] }, { type: _ionic_native_vibration_ngx__WEBPACK_IMPORTED_MODULE_7__["Vibration"] }, { type: _services_settings_service__WEBPACK_IMPORTED_MODULE_17__["SettingsService"] }, { type: _services_sys_service__WEBPACK_IMPORTED_MODULE_19__["SysService"] }, { type: _services_sys_data_service__WEBPACK_IMPORTED_MODULE_20__["DataService"] }, { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_8__["PopoverController"] }, { type: src_app_services_sys_map_service__WEBPACK_IMPORTED_MODULE_11__["MapService"] }, { type: src_app_services_sys_order_service__WEBPACK_IMPORTED_MODULE_12__["OrderService"] }, { type: _ionic_native_call_number_ngx__WEBPACK_IMPORTED_MODULE_6__["CallNumber"] }]; }, { reorderGroup: [{
